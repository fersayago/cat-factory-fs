...
export type TCreateCatPayload = paths["/cats"]["post"]["requestBody"]["content"]["application/json"];
export type TCreateCatResponse = paths["/cats"]["post"]["responses"]["201"]["content"]["application/json"];
export type TUpdateCatPayload = paths["/cats/{id}"]["patch"]["requestBody"]["content"]["application/json"];
